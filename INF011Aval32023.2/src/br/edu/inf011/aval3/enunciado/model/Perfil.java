...
//QUESTÃƒO 1 - PRODUCT em um BUILDER

//QUESTÃO 2 - OBJECT STRUCTURE em um VISITOR
public class Perfil {
	...
	public String toString() {
		...
		for(Documento doc : this.documentos)
			str.append(doc.aceitar(new VisitorFormatar()) + ((boolean) doc.aceitar(new VisitorValidar()) ? " [Vï¿½lido]" : "") + "\n");
		return str.toString();
